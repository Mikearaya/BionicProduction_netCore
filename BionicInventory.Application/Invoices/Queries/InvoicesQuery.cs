 ...
 * @Last Modified Time: Nov 15, 2018 7:20 PM
                    ...
                    id = sd.Key,
                        Detail = sd.Select (detail => new {
                            Id = detail.Id,
                                ...
                                customer = detail.CustomerOrder.Client.FullName,
                                customerId = detail.CustomerOrder.ClientId,
            ...
            return _database.Invoice
                .Where (i => i.Id == id).Select (i => new InvoiceDetailView () {
                    Id = i.Id,
                        ...
                        note = i.Note,
                        discount = i.Discount,
                        customer = i.InvoiceDetail.Select (d => new { info = d.CustomerOrderItem.CustomerOrder.Client }),
                        invoiceItems = i.InvoiceDetail.Select (d => new InvoiceItems () {
                            ItemName = d.CustomerOrderItem.Item.Name,
                                itemId = d.CustomerOrderItem.ItemId,
