 ...
 * @Last Modified Time: Jan 1, 2019 9:50 PM
...
namespace BionicInventory.Application.Inventory.WriteOffs.Commands.Create {
        ...
        public async Task<uint> Handle (NewWriteOffDto request, CancellationToken cancellationToken) {
            ...
            foreach (var data in request.WriteOffBatchs) {
                ...
                if (batch == null) {
                    ...
                    throw new QuantityGreaterThanAvailableException (nameof (StockBatchStorage), data.Quantity, batch.Quantity);
                }
