            ...
            return _database.CustomerOrderItem.Where (pOrder => pOrder.ProductionOrderList == null)
                ...
                .Select (po => new PendingOrdersView () {
                    salesOrderItemId = po.Id,
                        description = po.CustomerOrder.Description,
                        salesManId = po.CustomerOrder.CreatedBy,
                        salesMan = po.CustomerOrder.CreatedByNavigation.FullName (),
                        salesOrderId = po.CustomerOrderId,
                        ...
                        customer = (po.CustomerOrder != null) ? po.CustomerOrder.Client.FullName : "",
